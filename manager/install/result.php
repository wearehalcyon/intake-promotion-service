    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <h2 class="setupTitle">Congratulations!</h2>
                    <div class="card">
                        <p class="welcome success">
                            INTAKE Promotion Service Application was installed successfully!
                        </p>
                        <p class="admincredentials">
                            <strong>Your Administrator credentials:</strong>
                            <br>
                            <strong>Login:</strong> <i>admin</i> | <strong>Password:</strong> <i>admin</i>
                            <br>
                            <strong class="allert">Be sure to change this data in the account settings panel</strong>
                        </p>
                        <div class="installationButton">
                            <a class="button" href="/">Go to homepage</a> <a class="button" href="/login.php">Login to manager pannel</a>
                        </div>
                    </div>
            </div>
            <div class="col-md-3"></div>
